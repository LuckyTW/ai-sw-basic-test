"""
linux_level2_mission01 -- 리눅스 서버 보안 감사 도구 standalone pytest

원본 Validator: plugins/linux/validators/linux_auditor_validator.py
...
# ── 트랩 입력 파일 6개 (Validator에서 그대로 추출) ──
...
def test_log_stats(report_content):
    ...
    CPU 평균 관련 라인에서 숫자를 추출하여 기대값(36.32) +- 0.5 범위 내인지 확인.
    """
    # CPU 평균 관련 라인 탐색
    cpu_section = ""
    for line in report_content.split("\n"):
